<template>
  <div class="container mt-4">
    <img width="150px" src="@/assets/main_logo.png" alt="bike logo">
    <h1 class="central">Rental Reservations: Choose your options</h1>
    <div class="row">
      <div class="col-md-7">
        <div class="row">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      pay() {
        this.cart = [];
        alert("Thanks! Your reserving successfully completed. ");
      }
    }
  };
</script>
